...
from redxclassifiers import classical_ml_models

log = logging.getLogger(__name__)


number_of_default_models = 11
number_of_default_linear_models = 1
number_of_default_kernel_models = 2
number_of_default_bayesian_models = 1
number_of_default_ensemble_models = 6
number_of_default_neural_network_models = 1
...
def test_get_all_default_models():
    ...
    assert len(all_default_models) == number_of_default_models
...
def test_get_linear_default_models():
    ...
    assert len(models) == number_of_default_linear_models
...
def test_get_kernel_default_models():
    ...
    assert len(models) == number_of_default_kernel_models
...
def test_get_bayesian_default_models():
    ...
    assert len(models) == number_of_default_bayesian_models
...
def test_get_ensemble_default_models():
    ...
    assert len(models) == number_of_default_ensemble_models
...
def test_get_neural_network_default_models():
    ...
    assert len(models) == number_of_default_neural_network_models
