...
??? example "View Source"
        ...
        def objective_predefined_cv_multi_rmse__r2__diff_train_test(
            ...
            **kwargs,
            ...
            train_scores = np.empty(len(predefined_kfolds))
...
| predefined_kfolds | Tuple[np.ndarray] | _description_ | None |
...
```python3
def run_kfold_study_with_mlflow(
    models: List[redxclassifiers.classical_ml_models.skmodel],
    ...
    local_abs_store_path: Optional[str] = None,
    model_key_in_pipeline: Optional[str] = 'model',
    sampler: optuna.samplers._base.BaseSampler = <optuna.samplers._tpe.sampler.TPESampler object at 0x306b971d0>,
    training_smiles: Optional[List[str]] = None,
    experiment_description: Optional[str] = None
...
def run_train_test_study_with_mlflow(
    ...
    local_abs_store_path: Optional[str] = None,
    model_key_in_pipeline: Optional[str] = 'model',
    sampler: optuna.samplers._base.BaseSampler = <optuna.samplers._tpe.sampler.TPESampler object at 0x306b96cd0>,
    training_smiles: Optional[List[str]] = None,
    experiment_description: Optional[str] = None
) -> tuple[list[typing.Any], int]
```
